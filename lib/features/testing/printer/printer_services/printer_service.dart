...
class PrinterService {
  ...
  static final StreamController<String> _currentUsbStatusStreamController =
      StreamController();
  static Stream<String> currentUsbStringStatusStream =
      _currentUsbStatusStreamController.stream.asBroadcastStream();
  ...
  static bool get isPrinterConnected =>
      _currentUsbStatus == USBStatus.connected;

  static void init() {
    log('[PrinterService] init called');
    _currentUsbStatusStringSubscription =
        currentUsbStringStatusStream.listen((event) {});
  ...
  static Future<void> scan() async {
    if (_isScanning == false) {
      ...
      try {
        printerName = '';
        _printer = await _completer.future
  ...
  static Future<void> printInvoiceFromImage(
