...
import 'package:your_pos/features/testing/printer/custom_widgets/popup_message.dart';
import 'package:your_pos/features/testing/printer/printer_services/printer_service.dart';

class PrinterSettingScreen extends StatefulWidget {
  final Map<String, dynamic> data;
  const PrinterSettingScreen({super.key, required this.data});
        ...
        Container(
            ...
            child: StreamBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  isScanning =
                      PrinterService.printerStatus == PrinterStatus.scanning;
                  // log('[printer_page] usb printer status / isScanning: $isScanning');
                  // log(snapshot.data.toString());

                  if (snapshot.hasData &&
                      snapshot.data != null &&
                      snapshot.data != PrinterStatus.notFound &&
                      isScanning == false) {
                          ...
                          FilledButton.tonal(
                              onPressed: () async {
                                ...
                                if ([
                                  ...
                                  PrinterStatus.notFound
                                ].contains(PrinterService.printerStatus)) {
                                  await PrinterService.scan();
                                } else if (PrinterService.printerStatus ==
                                  ...
                                  PopUpMessage.showPopup(
                                      ...
                                      content:
                                          'Printer masih terkoneksi, putuskan koneksi terlebih dahulu sebelum scan');
                                }
                          ...
                          Text(PrinterService.printerStatus,
                              style: TextStyle(
                                color: PrinterService.isPrinterConnected
                                    ? Colors.green
                                    : Colors.black,
                                fontWeight: PrinterService.isPrinterConnected
                                    ? FontWeight.bold
                                    : FontWeight.normal,
                              )),
                        ],
